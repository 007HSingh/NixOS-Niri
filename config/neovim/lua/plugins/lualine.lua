return {
	...
	config = function()
		...
		local theme = {
			normal = {
				a = { fg = p.mauve, bg = bg, gui = "bold" },
				b = { fg = p.subtext1, bg = bg },
				c = { fg = p.subtext1, bg = bg },
			},
			insert = {
				a = { fg = p.green, bg = bg, gui = "bold" },
				b = { fg = p.subtext1, bg = bg },
				c = { fg = p.subtext1, bg = bg },
			},
			visual = {
				a = { fg = p.lavender, bg = bg, gui = "bold" },
				b = { fg = p.subtext1, bg = bg },
				c = { fg = p.subtext1, bg = bg },
			},
			replace = {
				a = { fg = p.red, bg = bg, gui = "bold" },
				b = { fg = p.subtext1, bg = bg },
				c = { fg = p.subtext1, bg = bg },
			},
			command = {
				a = { fg = p.peach, bg = bg, gui = "bold" },
				b = { fg = p.subtext1, bg = bg },
				c = { fg = p.subtext1, bg = bg },
			},
			terminal = {
				a = { fg = p.teal, bg = bg, gui = "bold" },
				b = { fg = p.subtext1, bg = bg },
				c = { fg = p.subtext1, bg = bg },
			},
			inactive = {
				a = { fg = p.overlay0, bg = bg },
				b = { fg = p.overlay0, bg = bg },
				c = { fg = p.overlay0, bg = bg },
			},
		}
